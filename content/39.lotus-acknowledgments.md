### Acknowledgments {.page_break_before .unnumbered}
...
The work on the Wikidata [IDSM](#idsm)/Sachem endpoint was supported by an ELIXIR CZ research infrastructure project grant (MEYS Grant No: LM2018131) including access to computing and storage facilities.
...
The authors would also like to thank contributors of all electronic [NP](#np) resources used in this work and the [NP](#np) community at large.
