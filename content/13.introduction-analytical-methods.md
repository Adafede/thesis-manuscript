...
The ions are then transferred to the mass analyzer using an electric field [@doi:10.1002/mas.10008].
...
While some exotic experiments were performed, the best compromise remains the alternation of full scans with Data Dependent Acquisition ([DDA](#dda)) [@doi:10.1021/acs.analchem.5b04491].
...
For this reason, coupling to another, more generic detector to assess quantities more accurately the amounts seems to be an alternative of choice.
...
As for [ESI](#esi), the mobile phase is first nebulized into droplets [@doi:10.1016/j.chroma.2008.07.080].
