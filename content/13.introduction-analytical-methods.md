...
As a preliminary note, none of these detectors alone can detect *all* [NP](#np)s [@doi:10.1055/s-0028-1088393; @doi:10.1002/jssc.200900152].
...
Before such detectors, compounds were often sprayed with specific reagents to become visible [@doi:10.1016/j.chroma.2010.12.068], as the detector was the human eye.
...
Besides these limitations, [ELSD](#elsd) remains a detector of choice for compounds without chromophore, such as sugars and lipids, or poorly ionized.
...
While some frameworks exist to *extend* the coverage of databases, they still rely on the initial compounds present in the database initially [@doi:10.1186/s13321-015-0087-1; @doi:10.1038/nmeth.4512].
