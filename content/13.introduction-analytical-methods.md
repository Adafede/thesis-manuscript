...
[ELSD](#elsd) is considered a generic detector because its response is roughly independent of the physicolchemical properties of the compound.
...
The first definition of “rapid annotation of previously reported major compounds of an extract” will be used for this thesis, with the distinction that it does not need be restricted to major compounds.
...
The structural elucidation of [NP](#np)s implies their isolation through chromatographic methods followed by, at least, [NMR](#nmr) methods [@doi:10.1039/C2NP20104F].
