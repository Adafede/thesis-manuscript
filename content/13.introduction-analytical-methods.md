...
MSNovelist is able to generate structures from fragmentation spectra, this without reference library.
It thus appears to be a perfect complement to library-based annotation, also allowing to best guide the complete structural elucidation.
...
One of the advantages of [NMR](#nmr) over [MS](#ms) is its quantitative response, only dependent 
of the molecular mass of the compound.
...
Together, [MS](#ms) and [NMR](#nmr) are an efficient combination for structural elucidation of [NP](#np)s [@doi:10.1021/acs.analchem.8b05112].
