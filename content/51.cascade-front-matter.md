### Automated composition assessment of natural extracts: An untargeted mass spectrometry-based metabolite profiling integrating semi-quantitative detection {.page_break_before}
