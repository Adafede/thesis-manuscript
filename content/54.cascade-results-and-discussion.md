...
Among the 44 CAD peaks, 15 were associated to 2D structures already reported in *S. chirayita*, and 31 in the *Swertia* genus.
One peak was associated with a 2D structure found in *Gentianaceae* and one in *Gentianales*. 
11 CAD peaks remained without satisfying unambiguous confident annotation.
These peaks are to be prioritized for further investigation.
The majority of the annotated structures were xanthones.
For the ease of the analyst and, for example, to suggest specifications for a group of compounds, Table @tbl:cascade-4 can be aggregated by compound classes.
Both tables correspond to the two views illustrated in Figure @fig:cascade-7, but this time with PI and NI merged together.
This way, the composition of the extract can be approached from a more global way, with compounds sharing similar properties (here structural classes) regroupped together.
An example of such condensed report is presented in Table @tbl:cascade-5.
...
![**TODO.** TODO.](images/cascade-8.pdf "cascade-8"){#fig:cascade-8 short-caption="TODO" align="center" width="100%"}

Such comparison... develop TODO
