...
|Peak [ID](#id)|Peak RT [min]|Peak Area [%]|Feature [ID](#id)|Feature RT [min]|Feature *m/z*|Structure|[InChIKey](#inchikey) [2D](#2d)|Annotation Score|Chemical Pathway|Chemical Superclass|Chemical Class|Nearest Organism\footnotemark{}|Reference(s)|
|-:|-:|-:|-:|-:|-:|-----|------|--:|----|----|-----|--|-|
...
Of the 44 [CAD](#cad) peaks, 15 were associated with [2D](#2d) structures previously reported in *S. chirayita*, and 31 in the genus *Swertia*.
One peak was associated with a [2D](#2d) structure found in *Gentianaceae* and one in *Gentianales*. 
