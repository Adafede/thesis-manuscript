...
In fact, even if there are annotated features under their envelope before fitering, after filtering, some of the [CAD](#cad) peaks could not be linked anymore to any confidently annotated and peak-shape correlated feature. 
...
*S. chirayita* is not a well studied species, neither the *Swertia* genus, but the Gentianaceae family is (see Figure @fig:intro-1).
...
The table reports the 44 integrated [CAD](#cad) peaks, of which 15  were associated with [2D](#dd) structures previously reported in *S. chirayita*, and 31 in the genus *Swertia*.
...
These peaks should be prioritized for further expert investigation, aiming at unambiguous structural elucidation.
