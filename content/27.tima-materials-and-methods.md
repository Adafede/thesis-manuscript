...
This approach is focused on specialized metabolites annotation and is constituted by a pre-fragmented theoretical spectral [DB](#db) version of the DNP.
...
The HPLC conditions were selected as follows: Waters X-Bridge C18 column (250 × 19 mm i.d., 5 *μ*m) equipped with a Waters C18 pre-column cartridge holder (10 × 19 mm i.d.); solvent system consists of [ACN](#acn) (2 mM TEA) (B) and H2O (2 mM TEA & 2 mM ammonium acetate) (A).
