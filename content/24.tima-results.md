...
The ethyl acetate and methanolic extracts of the three species were profiled by UHPLC-[HRMS](#hrms) in positive ionization mode using a data-dependent [MS/MS](#msms) acquisition.
...
Both features were targeted within the extract and, after isolation, the structure of their corresponding compound was determined by 1D and 2D [NMR](#nmr) measurements (see spectra in Supplementary Material [S1](#s1.-structural-elucidation-of-predicentrine) and [S2](#s2.-structural-elucidation-of-glaucine)).
