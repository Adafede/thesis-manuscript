...
TODO EXPLAIN DMSO GENEIRC BIO, PRINCIPLE GENERALIZABLE
...
TODO EXPLAIN SAMPLE PRINCIPLE GENERIC INSTRUMENTS
...
![**Cluster Containing Cinchona Alkaloids Before and After Optimization.** The cluster after optimization contains more nodes and annotations (in blue). TODO RAPPEL QCMIX](images/figure-tac-1.pdf "ci-3"){#fig:ci-3 short-caption="Cluster Containing Cinchona Alkaloids Before and After Optimization" align="center" width="100%"}
