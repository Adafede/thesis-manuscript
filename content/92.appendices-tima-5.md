## S5. Output of the Taxonomically Informed Scoring Annotation Using [ISDB](#isdb)-[DNP](#dnp) for Feature [*m/z*](#mz) 356.1860 at 1.83 Min {.page_break_before}

\tiny

Table: S5. Output of the taxonomically informed scoring annotation using [ISDB](#isdb)-[DNP](#dnp) for feature [*m/z*](#mz) 356.1860 at 1.83 min
