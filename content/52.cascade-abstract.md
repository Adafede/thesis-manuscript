...
For this, we use an analytical platform that combines Liquid Chromatography-Mass Spectrometry (LC-MS) with Charged Aerosol Detection (CAD).
We then establish generic metabolite profiling for the concomitant recording of qualitative MS data and semi-quantitative CAD profiles. 

The deconvoluted MS features (recorded in HRMS/MS DDA) were grouped and annotated using state-of-the-art tools.
