...
Indeed, all compounds of the benchmarking dataset are present in the [DNP](#dnp)), and the ISDB-DNP tool, which is by definition backed by the same [DB](#db) is thus favored.
