...
### Manual addition of a referenced structure-organism pair to Wikidata {.unlisted .unnumbered}

#### Select a referenced structure-organism pair {.unlisted .unnumbered}
...
#### Fetch the information for the referenced structure-organism pair {.unlisted .unnumbered}
...
![](images/tutorial/2021-02-25-14-15-54.png "tutorial-01"){width="100%"}
...
\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-27-18-40-20.png "tutorial-02"){width="100%"}
\captionsetup[figure]{list=yes}
...
#### Check for the presence of your compound in Wikidata <a name="check_compound"></a> {.unlisted .unnumbered}
...
Alternatively you can use the following Scholia link (replace by your compounds InChIKey) \
[https://scholia.toolforge.org/inchikey/QOVGHDRCAGYGEB-FFZYJECLSA-N](https://scholia.toolforge.org/inchikey/QOVGHDRCAGYGEB-FFZYJECLSA-N) 
...
#### Add your data manually to Wikidata <a name="add_your_data_manually"></a> {.unlisted .unnumbered}
...
\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-18-03.png "tutorial-03"){width="100%"}
\captionsetup[figure]{list=yes}

An empty page with a new Wikidata identifier is created 

\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-18-50.png "tutorial-04"){width="100%"}
\captionsetup[figure]{list=yes}

##### Add the chemical compound information <a name="add_chemical"></a> {.unlisted .unnumbered}

Create a new statement for ```is an instance of```

\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-20-08.png "tutorial-05"){width="100%"}
\captionsetup[figure]{list=yes}

and select chemical compound (i.e. [Q11173](https://www.wikidata.org/wiki/Q11173)):

\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-20-58.png "tutorial-06"){width="100%"}
\captionsetup[figure]{list=yes}
...
\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-22-44.png "tutorial-07"){width="100%"}
\captionsetup[figure]{list=yes}
...
\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-24-34.png "tutorial-08"){width="100%"}
\captionsetup[figure]{list=yes}
...
##### Add the biological source information <a name="add_bio"></a> {.unlisted .unnumbered}
...
\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-31-56.png "tutorial-09"){width="100%"}
\captionsetup[figure]{list=yes}
...
\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-33-14.png "tutorial-10"){width="100%"}
\captionsetup[figure]{list=yes}
...
##### Add the reference documenting the structure-organism pair <a name="add_ref"></a> {.unlisted .unnumbered}
...
\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-35-33.png "tutorial-11"){width="100%"}
\captionsetup[figure]{list=yes}

Here, we use the ```stated in``` property ([P248](https://www.wikidata.org/wiki/Property:P248)):

\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-36-33.png "tutorial-12"){width="100%"}
\captionsetup[figure]{list=yes}
...
\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-38-54.png "tutorial-13"){width="100%"}
\captionsetup[figure]{list=yes}

Click ```publish``` to save your changes and make them public.

\captionsetup[figure]{list=no}
![](images/tutorial/2021-02-25-14-39-48.png "tutorial-14"){width="100%"}
\captionsetup[figure]{list=yes}

##### Check whether your target reference is already on Wikidata <a name="check_ref"></a> {.unlisted .unnumbered}
...
If you prefer to resolve your DOI to Wikidata directly, you can do so by using the uppercase-normalized DOI in the following URL pattern: \
[https://hub.toolforge.org/P356:**10.1021/OL2030907**](https://hub.toolforge.org/P356:10.1021/OL2030907), which will lead you to the respective Wikidata page, in this case [Q83059010](https://www.wikidata.org/wiki/Q83059010).
