...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/adafede/thesis-manuscript/tree/gh-pages) and [`output`](https://github.com/adafede/thesis-manuscript/tree/output) branches.
...
Please attribute by linking to https://github.com/adafede/thesis-manuscript.
